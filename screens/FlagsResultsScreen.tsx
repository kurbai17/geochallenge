...
type FlagsResultsRouteProp = RouteProp<RootStackParamList, 'FlagsResults'>;

export default function FlagsResultsScreen() {
  const route = useRoute<FlagsResultsRouteProp>();
